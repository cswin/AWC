...
class EncoderDiscriminator(nn.Module):
    ...
    def __init__(self, ch, ndf = 16):
        super(EncoderDiscriminator, self).__init__()

        self.conv1 = nn.Conv2d(ch, ndf, kernel_size=3, stride=1, padding=1)
...
class LowlevelfeatureDiscriminator(nn.Module):

    def __init__(self, ch, ndf = 64):
        super(LowlevelfeatureDiscriminator, self).__init__()

        self.conv1 = nn.Conv2d(ch, ndf, kernel_size=4, stride=2, padding=1)
        self.conv2 = nn.Conv2d(ndf, ndf*2, kernel_size=4, stride=2, padding=1)
        self.conv3 = nn.Conv2d(ndf*2, ndf*4, kernel_size=4, stride=2, padding=1)
