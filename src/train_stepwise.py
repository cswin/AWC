...
def main():
    ...
    refine_optimizer = optim.SGD(refine_params,
                                  lr=args.learning_rate,
                                  momentum=args.momentum,
                                  weight_decay=args.weight_decay)
    ...
    for i_iter in range(args.num_steps):
        ...
        adjust_learning_rate(refine_optimizer, i_iter, args)
        ...
        if i_iter >= args.num_steps_stop - 1:
            print('save model ...')
            filename = 'UNet' + str(args.num_steps_stop) + 'v20_miccai_jointOpt_attention.pth'
        ...
        if i_iter % args.save_pred_every == 0 and i_iter != 0:
            ...
            filename = 'UNet' + str(i_iter) + 'v20_miccai_jointOpt_attention.pth'
            torch.save(teacher_net.cpu().state_dict(),
                       os.path.join(args.snapshot_dir, filename))
            teacher_net.cuda(args.gpu)
